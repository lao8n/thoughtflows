...
Used by the decision-graph (run_prototype), gate-tracker (run_gatetracker), and the
reference builder (build_reference). Extracted to kill the copies that had drifted
across those stages.
"""
